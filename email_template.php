...
<head>
    ...
    <title>New contact form submission from [GitHub] — <?= $subject; ?></title>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; background:#ffffff; border:1px solid #e5e7eb; border-radius:6px; overflow:hidden;" class="bg-card">
                    <tr>
                        <td align="left" style="background:#2563eb; padding:24px; font-size:20px; line-height:24px; font-weight:700; color:#ffffff; font-family:Arial,Helvetica,sans-serif;" class="h1">
                            <span class="badge" style="display:inline-block; background:#1d4ed8; color:#fff; padding:4px 10px; font-size:11px; line-height:1; letter-spacing:.5px; border-radius:3px; text-transform:uppercase;">
                                New Message
                            </span>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding:0 0 18px 0; vertical-align:top;">
                                            <div style="font-size:11px; color:#6b7280; text-transform:uppercase; letter-spacing:.5px; margin:0 0 4px 0; font-weight:600;">Date</div>
                                            <div style="font-size:15px; color:#111827; font-weight:500;"><?= $date; ?></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:0 0 18px 0; vertical-align:top;">
                                            <div style="font-size:11px; color:#6b7280; text-transform:uppercase; letter-spacing:.5px; margin:0 0 4px 0; font-weight:600;">Name</div>
                                    ...
                                    <tr>
                                        <td style="padding:0; vertical-align:top;">
                                            <div style="font-size:11px; color:#6b7280; text-transform:uppercase; letter-spacing:.5px; margin:0 0 8px 0; font-weight:600;">Message</div>
